...
- **共享实例**（免费版 / 基础版）与 **Serverless 独享实例** 均使用标准 MySQL 协议，驱动配置方式相同。
- 免费版并发连接上限 <UserDbPlanValue planCode="Free" field="conn" />，基础版 <UserDbPlanValue planCode="Basic" field="conn" />，Serverless 最大 3000；应用请使用连接池并控制连接数。
